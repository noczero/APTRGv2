...
namespace APTRGv2
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv2.Controls.r.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(APTRGv2.Controls.r.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(APTRGv2.Controls.r.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(APTRGv2.Controls.r.TurnCoordinatorMarks);

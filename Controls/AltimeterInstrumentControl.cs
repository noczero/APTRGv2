...
namespace APTRGv2
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv2.Controls.r.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(APTRGv2.Controls.r.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(APTRGv2.Controls.r.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(APTRGv2.Controls.r.Bandeau_Dérouleur);

...
namespace APTRGv2
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv2.Controls.r.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(APTRGv2.Controls.r.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(APTRGv2.Controls.r.Maquette_Avion);

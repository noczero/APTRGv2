...
namespace APTRGv2
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv2.Controls.r.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(APTRGv2.Controls.r.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(APTRGv2.Controls.r.HeadingIndicator_Aircraft);        
